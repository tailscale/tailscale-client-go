...
func TestClient_SetDeviceSubnetRoutes(t *testing.T) {
	...
	assert.NoError(t, With(client).SetDeviceSubnetRoutes(context.Background(), deviceID, routes))
...
func TestClient_Devices(t *testing.T) {
	...
	actualDevices, err := With(client).Devices(context.Background())
...
func TestClient_DeleteDevice(t *testing.T) {
	...
	assert.NoError(t, With(client).DeleteDevice(ctx, deviceID))
...
func TestClient_DeviceSubnetRoutes(t *testing.T) {
	...
	routes, err := With(client).DeviceSubnetRoutes(context.Background(), deviceID)
	assert.NoError(t, err)
	assert.Equal(t, http.MethodGet, server.Method)
	assert.Equal(t, "/api/v2/device/test/routes", server.Path)
...
func TestClient_AuthorizeDevice(t *testing.T) {
	...
	assert.NoError(t, With(client).AuthorizeDevice(context.Background(), deviceID))
	assert.Equal(t, http.MethodPost, server.Method)
...
func TestClient_SetDeviceAuthorized(t *testing.T) {
	...
	for _, value := range []bool{true, false} {
		assert.NoError(t, With(client).SetDeviceAuthorized(context.Background(), deviceID, value))
		assert.Equal(t, http.MethodPost, server.Method)
		assert.Equal(t, "/api/v2/device/test/authorized", server.Path)
...
func TestClient_SetDeviceTags(t *testing.T) {
	...
	assert.NoError(t, With(client).SetDeviceTags(context.Background(), deviceID, tags))
...
func TestClient_SetDeviceKey(t *testing.T) {
	...
	assert.NoError(t, With(client).SetDeviceKey(context.Background(), deviceID, expected))
...
func TestClient_SetDeviceIPv4Address(t *testing.T) {
	...
	assert.NoError(t, With(client).SetDeviceIPv4Address(context.Background(), deviceID, address))
	assert.Equal(t, http.MethodPost, server.Method)
...
func TestClient_UserAgent(t *testing.T) {
	...
	assert.NoError(t, With(client).SetDeviceAuthorized(context.Background(), "test", true))
